	...
	<tr>
		...
		<td style="width: 80%;">
			<table cellspacing="1" cellpadding="0" border="0" style="width: 100%;">
				...
				<tr>
					<td><input readonly="readonly" class="form-control input_field" onclick="highlight(this);" type="text" style="width: 605px;" value="&lt;a href=&quot;<# BASE_URL #>viewer.php?file=<# FILENAME #>&quot;&gt;&lt;img src=&quot;<# BASE_URL #>images/<# FILENAME_THUMB #>&quot; border=&quot;0&quot; alt=&quot;<# FILENAME #>&quot; /&gt;&lt;/a&gt;" /></td>
					<td>Thumbnail for Website</td>
				</tr>
				<tr>
					<td><input readonly="readonly" class="form-control input_field" onclick="highlight(this);" type="text" style="width: 605px;" value="[URL=<# BASE_URL #>viewer.php?file=<# FILENAME #>][IMG]<# BASE_URL #>images/<# FILENAME_THUMB #>[/IMG][/URL]" /></td>

...
Direct Links:
<textarea class="input_field" onclick="highlight(this);" cols="50" rows="10" readonly="readonly" style="width: 880px; resize: none;overflow: auto;"><while id="uploadinfo_whileloop_1"><# BASE_URL #>viewer.php?file=<# FILENAME #>
</endwhile></textarea>
Thumbnails for Website:
<textarea class="input_field" onclick="highlight(this);" cols="50" rows="10" readonly="readonly" style="width: 880px; resize: none;overflow: auto;"><while id="uploadinfo_whileloop_2">&lt;a href=&quot;<# BASE_URL #>viewer.php?file=<# FILENAME #>&quot;&gt;&lt;img src=&quot;<# THUMBNAIL #>&quot; border=&quot;0&quot; alt=&quot;<# FILENAME #>&quot; /&gt;&lt;/a&gt; </endwhile></textarea>
Thumbnails for Forum:
<textarea class="input_field" onclick="highlight(this);" cols="50" rows="10" readonly="readonly" style="width: 880px; resize: none;overflow: auto;"><while id="uploadinfo_whileloop_3">[URL=<# BASE_URL #>viewer.php?file=<# FILENAME #>][IMG]<# THUMBNAIL #>[/IMG][/URL] </endwhile></textarea>	
</endif>
